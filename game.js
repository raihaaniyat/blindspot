    ...
    enemies: [
        {
            ...
            y: 200,
            radius: 12,
            speed: 1.5,      // Slower than player (important for balance!)
            isFrozen: false, // Whether they're currently frozen
        },
        {
            x: 400,
            y: 400,
...
function checkGameConditions() {
    ...
    if (distToGoal < p.radius + game.goal.radius) {
        game.state = 'won';
        gameStatusEl.textContent = '🎉 Level Complete! Press R to restart';
...
function restartGame() {
    ...
    // Reset enemies
    game.enemies[0].x = 400;
    game.enemies[0].y = 200;
    game.enemies[1].x = 400;
    game.enemies[1].y = 400;
    
    // Reset game state
    game.state = 'playing';
    gameStatusEl.textContent = 'Watch your blindspot!';
